...
| 다른 폴드 기기·Android 14 | 기능 미검증 |

설치 최소 버전은 Android 14입니다. 기기별 차이와 아직 확인하지 못한 동작은 [호환성 안내](docs/COMPATIBILITY.md)를 확인하세요. 화면 읽기 기능과의 동시 사용은 지원하지 않습니다.
...
**Codex·Claude Code 같은 에이전트로 설치하려면** [에이전트 설치 안내](docs/AGENT_INSTALL.md)를 읽게 해 주세요. 저장소의 시작 문서는 [AGENTS.md](AGENTS.md)입니다. 이렇게 요청할 수 있습니다.

> 이 저장소의 AGENTS.md와 에이전트 설치 안내를 읽고 내 폰에 폴드패치를 설치해 줘. 할 수 있는 단계는 직접 진행하고, 내가 폰에서 해야 할 때 알려 줘. 기존 앱 데이터와 설정은 유지해 줘.
