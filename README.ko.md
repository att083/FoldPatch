...
**[APK 다운로드](https://github.com/att083/FoldPatch/releases/download/v0.1.0-alpha.5/foldpatch-release.apk)** · [설치 안내](docs/INSTALL.md) · [호환성](docs/COMPATIBILITY.md)
...
1. **[foldpatch-release.apk](https://github.com/att083/FoldPatch/releases/download/v0.1.0-alpha.5/foldpatch-release.apk)**를 받아 설치합니다.
