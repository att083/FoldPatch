...
**[下载与安装 APK](docs/INSTALL.zh-Hans.md)** · [兼容性（英文）](docs/COMPATIBILITY.en.md)
...
**直接安装现成的 APK，无需自行编译。** 目前为早期 Alpha 版本，正在准备首次 GitHub 发布。

1. 发布后，从 Release 的 **Assets** 下载并安装 **`foldpatch-release.apk`**。
