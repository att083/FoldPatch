...
public final class GestureLayerProbe {
    private static final List<SurfaceControl> surfaces = new ArrayList<>();
    private static SurfaceControl root, anchor;
    ...
    private static synchronized void cleanup() {
        ...
        if(monitor!=null)try{call(monitor,"dispose",new Class<?>[0]);}catch(Exception ignored){}
    ...
    public static void main(String[] args) throws Exception {
        ...
        Runtime.getRuntime().addShutdownHook(new Thread(GestureLayerProbe::cleanup));
        ...
        try {
            ...
            try(SurfaceControl.Transaction t=new SurfaceControl.Transaction()) {
                call(t,"setInputWindowInfo",new Class<?>[]{SurfaceControl.class,hc},anchor,handle);
            ...
            try (SurfaceControl.Transaction t = new SurfaceControl.Transaction()) {
                // Layer stack inherited from the display-owned host.
