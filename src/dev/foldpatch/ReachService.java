...
public final class ReachService extends Service implements DisplayManager.DisplayListener {
    ...
    void open(){
        ...
        else try{startActivity(new Intent(this,MainActivity.class).addFlags(Intent.FLAG_ACTIVITY_NEW_TASK));}catch(Exception e){android.util.Log.w("FoldPatch","Open from notification instead",e);}
    }
