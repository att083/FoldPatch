...
public final class ProbeActivity extends Activity {
    ...
    final class Probe extends View {
        ...
        @Override protected void onSizeChanged(int w,int h,int oldw,int oldh){android.util.Log.i("FoldPatchProbe","layout="+w+"x"+h+" density="+getResources().getDisplayMetrics().densityDpi);}
        ...
        @Override public boolean onTouchEvent(MotionEvent e){
            ...
            if(e.getActionMasked()==MotionEvent.ACTION_UP){taps++;touchX=e.getX();touchY=e.getY();android.util.Log.i("FoldPatchProbe","tap="+taps+" x="+touchX+" y="+touchY+" display="+getDisplay().getDisplayId());}
