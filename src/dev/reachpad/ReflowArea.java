...
final class ReflowArea {
    ...
    void start(int w,int h,int usable)throws Exception{
        ...
        ProcessBuilder b=new ProcessBuilder("/system/bin/app_process","/system/bin","dev.reachpad.ReflowGuard",String.valueOf(w),String.valueOf(h),String.valueOf(usable));
    ...
    void stop(){
        ...
        try{
            ...
            ProcessBuilder b=new ProcessBuilder("/system/bin/app_process","/system/bin","dev.reachpad.ReflowGuard",String.valueOf(width),String.valueOf(height),"0");
            b.environment().put("CLASSPATH",apk);b.redirectError(ProcessBuilder.Redirect.INHERIT);
