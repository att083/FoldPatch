...
public final class NativeService extends Service implements DisplayManager.DisplayListener {
    ...
    private void send(MotionEvent e){Parcel p=Bridge.data();try{e.writeToParcel(p,0);IBinder b=BridgeProvider.helper;if(b!=null)b.transact(8,p,null,IBinder.FLAG_ONEWAY);}catch(Exception failure){android.util.Log.e("ReachPadNative","Touch",failure);}finally{p.recycle();}}
