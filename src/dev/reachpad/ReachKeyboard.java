...
public final class ReachKeyboard extends InputMethodService {
    ...
    @Override public void onStartInputView(EditorInfo e,boolean restarting){super.onStartInputView(e,restarting);shown=true;onDisplay=getDisplay()==null?0:getDisplay().getDisplayId();rebuild();android.util.Log.i("ReachPadKeyboard","shown display="+onDisplay+" width="+width+" top="+top);}
    @Override public void onFinishInputView(boolean finishing){shown=false;top=Integer.MAX_VALUE;notifyHost();android.util.Log.i("ReachPadKeyboard","hidden finishing="+finishing);super.onFinishInputView(finishing);}
