...
public final class ReflowGuard {
    ...
    private synchronized void restore(){
        ...
        if(changed&&organizer.valid())try{bounds(new Rect());restored=true;changed=false;}catch(Exception e){android.util.Log.e("ReachPadReflow","Restore bounds",e);}
        try{organizer.close();}catch(Exception e){android.util.Log.w("ReachPadReflow","Unregister",e);}
