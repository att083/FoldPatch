...
public final class PointerAccessibility extends AccessibilityService {
    ...
    boolean attachPresentation(SurfaceControl surface,long generation){
        ...
        catch(Exception e){surface.release();android.util.Log.e("ReachPadNative","Attach presentation",e);return false;}
    }
    void detachPresentation(){
        ...
        catch(Exception e){android.util.Log.w("ReachPadNative","Detach presentation",e);}
