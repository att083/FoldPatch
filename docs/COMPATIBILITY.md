...
확인일: 2026-09-20. 지원 목표는 손상된 Galaxy Fold의 Android 15부터 최신 정식 Android 17까지다. 설치 최소 조건은 Android 14이며, 설치 가능 버전과 실제 기능 검증 범위는 다르다. `targetSdkVersion`은 지원하는 최대 Android 버전이 아니다.
...
| 다른 Fold 모델·Android 14 | 설치 조건만 충족할 수 있음 | 해당 기기에서의 기능 확인 |
